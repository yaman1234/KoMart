...
export function DashboardPage() {
  ...
  const { dateRange, setDateRange, isEditing, setIsEditing } = useDashboardStore();
          ...
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Grid container spacing={1}>
                {[
                  { label: 'New Sale', icon: <PointOfSaleIcon />, path: '/pos' },
                  { label: 'Add Product', icon: <AddIcon />, path: '/products/new' },
                  { label: 'View Reports', icon: <AssessmentIcon />, path: '/reports' },
                ].map((action) => (
