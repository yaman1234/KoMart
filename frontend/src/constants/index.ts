...
export const APP_LOGO = '/koMart_logo.png';
...
export const QUERY_KEYS = {
  ...
  productPurchasePriceHistory: (id: string) => ['products', id, 'purchase-price-history'] as const,
  ...
  purchaseReturns: (poId?: string) =>
    poId ? (['purchaseReturns', poId] as const) : (['purchaseReturns'] as const),
  purchaseReturnable: (poId: string) => ['purchaseReturns', 'available', poId] as const,
